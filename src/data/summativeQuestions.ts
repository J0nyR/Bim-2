...
export const summativeQuestions: Question[] = [
  ...
  { id: 81, question: "Apa keuntungan utama sistem bahan bakar 'common rail' dibandingkan sistem pompa 'jerk' tradisional?", question_en: "What is a key advantage of a 'common rail' fuel system over a traditional 'jerk' pump system?", options: { A: { text: "Kontrol waktu dan tekanan injeksi yang lebih presisi", text_en: "More precise control over injection timing and pressure" }, B: { text: "Lebih sederhana dan lebih sedikit komponen", text_en: "Simpler and has fewer components" }, C: { text: "Tidak memerlukan bahan bakar bertekanan tinggi", text_en: "Does not require high-pressure fuel" }, D: { text: "Hanya digunakan untuk mesin kecil", text_en: "It is only used for small engines" } }, answer: "A", topic: "Marine Engines" },
  { id: 82, question: "Dalam sistem pendingin mesin laut yang umum, fluida apa yang secara langsung mendinginkan silinder mesin?", question_en: "In a typical marine engine cooling system, what fluid directly cools the engine cylinders?", options: { A: { text: "Air laut", text_en: "Sea water" }, B: { text: "Air tawar (Freshwater)", text_en: "Freshwater" }, C: { text: "Oli pelumas", text_en: "Lubricating oil" }, D: { text: "Udara", text_en: "Air" } }, answer: "B", topic: "Marine Engines" },
  { id: 83, question: "Tujuan utama sistem oli pelumas pada mesin adalah...", question_en: "The primary purpose of the lubricating oil system in an engine is...", options: { A: { text: "Mendinginkan bahan bakar", text_en: "To cool the fuel" }, B: { text: "Mengurangi gesekan dan keausan di antara bagian yang bergerak", text_en: "To reduce friction and wear between moving parts" }, C: { text: "Meningkatkan tenaga mesin", text_en: "To increase engine power" }, D: { text: "Membersihkan gas buang", text_en: "To clean the exhaust gas" } }, answer: "B", topic: "Marine Engines" },
  { id: 84, question: "'Exhaust gas boiler' atau 'economizer' digunakan untuk...", question_en: "An 'exhaust gas boiler' or 'economizer' is used to...", options: { A: { text: "Menghasilkan uap menggunakan panas dari gas buang mesin utama", text_en: "Produce steam using heat from the main engine exhaust" }, B: { text: "Meredam suara gas buang", text_en: "Muffle the sound of the exhaust gas" }, C: { text: "Mendinginkan gas buang sebelum dilepaskan", text_en: "Cool the exhaust gas before release" }, D: { text: "Meningkatkan tekanan gas buang", text_en: "Increase the exhaust gas pressure" } }, answer: "A", topic: "Marine Engines" },
  { id: 85, question: "Apa perbedaan antara 'indicated power' dan 'brake power'?", question_en: "What is the difference between 'indicated power' and 'brake power'?", options: { A: { text: "Tidak ada perbedaan", text_en: "There is no difference" }, B: { text: "Indicated power adalah daya di baling-baling, brake power adalah daya di mesin", text_en: "Indicated power is power at the propeller, brake power is power at the engine" }, C: { text: "Indicated power adalah daya teoretis di dalam silinder, brake power adalah daya yang dapat digunakan di poros engkol", text_en: "Indicated power is the theoretical power inside the cylinders, brake power is the usable power at the crankshaft" }, D: { text: "Brake power selalu lebih besar dari indicated power", text_en: "Brake power is always greater than indicated power" } }, answer: "C", topic: "Marine Engines" },

  // Marine Boiler (25 questions)
  {
    id: 21,
  ...
  { id: 86, question: "Apa perbedaan antara 'scum blowdown' dan 'bottom blowdown'?", question_en: "What is the difference between a 'scum blowdown' and a 'bottom blowdown'?", options: { A: { text: "Keduanya sama, hanya beda nama", text_en: "They are the same, just different names" }, B: { text: "Scum blowdown untuk tekanan tinggi, bottom blowdown untuk tekanan rendah", text_en: "Scum blowdown is for high pressure, bottom blowdown is for low pressure" }, C: { text: "Scum membuang kotoran di permukaan air, bottom membuang endapan di dasar", text_en: "Scum removes impurities at the water surface, bottom removes sludge at the base" }, D: { text: "Scum blowdown menggunakan uap, bottom blowdown menggunakan air", text_en: "Scum blowdown uses steam, bottom blowdown uses water" } }, answer: "C", topic: "Marine Boiler" },
  { id: 87, question: "'Composite boiler' adalah jenis boiler yang dapat...", question_en: "A 'composite boiler' is a type of boiler that can...", options: { A: { text: "Hanya menggunakan bahan bakar padat", text_en: "Only use solid fuel" }, B: { text: "Dinyalakan dengan oli dan/atau menggunakan gas buang dari mesin", text_en: "Be oil-fired and/or use exhaust gas from an engine" }, C: { text: "Menghasilkan uap dan air panas secara bersamaan", text_en: "Produce steam and hot water simultaneously" }, D: { text: "Beroperasi tanpa air", text_en: "Operate without water" } }, answer: "B", topic: "Marine Boiler" },
  { id: 88, question: "Apa tujuan dari 'air vent cock' di bagian atas drum uap boiler?", question_en: "What is the purpose of the 'air vent cock' on the top of a boiler steam drum?", options: { A: { text: "Untuk mengambil sampel uap", text_en: "To take a steam sample" }, B: { text: "Untuk melepaskan udara saat mengisi boiler dan saat start-up", text_en: "To release air when filling the boiler and during start-up" }, C: { text: "Untuk menghubungkan pengukur tekanan", text_en: "To connect a pressure gauge" }, D: { text: "Sebagai katup keselamatan cadangan", text_en: "To act as a backup safety valve" } }, answer: "B", topic: "Marine Boiler" },
  { id: 89, question: "Apa konsekuensi langsung dari 'kegagalan nyala api' (flame failure) pada boiler yang bekerja secara otomatis?", question_en: "What is the immediate consequence of a 'flame failure' in an automatically fired boiler?", options: { A: { text: "Alarm akan berbunyi tetapi boiler tetap menyala", text_en: "An alarm will sound but the boiler stays on" }, B: { text: "Pasokan air akan berhenti", text_en: "The water supply will stop" }, C: { text: "Pasokan bahan bakar segera dimatikan", text_en: "The fuel supply is shut off immediately" }, D: { text: "Tekanan uap akan meningkat", text_en: "The steam pressure will increase" } }, answer: "C", topic: "Marine Boiler" },
  { id: 90, question: "Mengapa pengolahan kimia air umpan boiler diperlukan?", question_en: "Why is chemical treatment of boiler feedwater necessary?", options: { A: { text: "Untuk memberi warna pada air", text_en: "To give color to the water" }, B: { text: "Untuk mencegah korosi, pembentukan kerak, dan mengontrol pH", text_en: "To prevent corrosion, scale formation, and control pH" }, C: { text: "Untuk membuat air lebih cepat mendidih", text_en: "To make the water boil faster" }, D: { text: "Hanya diperlukan untuk boiler pipa api", text_en: "It is only required for fire-tube boilers" } }, answer: "B", topic: "Marine Boiler" },

  // Shafting & Propeller (25 questions)
  {
    id: 41,
  ...
  { id: 91, question: "Apa itu 'propeller singing'?", question_en: "What is 'propeller singing'?", options: { A: { text: "Suara bernada tinggi yang disebabkan oleh aliran air di atas bilah baling-baling", text_en: "A high-pitched noise caused by water flowing over the propeller blades" }, B: { text: "Alarm yang menandakan baling-baling rusak", text_en: "An alarm that indicates a damaged propeller" }, C: { text: "Proses pemolesan baling-baling", text_en: "The process of polishing a propeller" }, D: { text: "Getaran normal dari baling-baling", text_en: "Normal vibration from the propeller" } }, answer: "A", topic: "Shafting & Propeller" },
  { id: 92, question: "Apa tujuan dari 'gearbox' dalam sistem propulsi dengan mesin diesel putaran menengah?", question_en: "What is the purpose of a 'gearbox' in a propulsion system with a medium-speed diesel engine?", options: { A: { text: "Meningkatkan putaran mesin", text_en: "To increase the engine RPM" }, B: { text: "Mengurangi RPM mesin yang tinggi ke RPM baling-baling yang lebih rendah dan efisien", text_en: "To reduce the high engine RPM to a lower, efficient propeller RPM" }, C: { text: "Mendinginkan mesin", text_en: "To cool the engine" }, D: { text: "Menghubungkan dua mesin menjadi satu", text_en: "To connect two engines together" } }, answer: "B", topic: "Shafting & Propeller" },
  { id: 93, question: "Anoda korban (sacrificial anodes) dipasang di area buritan kapal untuk...", question_en: "Sacrificial anodes are fitted to the stern area of a ship to...", options: { A: { text: "Menambah berat kapal", text_en: "Add weight to the ship" }, B: { text: "Mencegah korosi galvanik pada lambung dan baling-baling", text_en: "Prevent galvanic corrosion of the hull and propeller" }, C: { text: "Meningkatkan daya dorong", text_en: "Increase thrust" }, D: { text: "Mengurangi getaran", text_en: "Reduce vibration" } }, answer: "B", topic: "Shafting & Propeller" },
  { id: 94, question: "Mengapa 'pemolesan baling-baling' (propeller polishing) rutin dilakukan?", question_en: "Why is regular 'propeller polishing' performed?", options: { A: { text: "Agar terlihat bagus", text_en: "To make it look good" }, B: { text: "Untuk menyeimbangkan baling-baling", text_en: "To balance the propeller" }, C: { text: "Untuk meningkatkan efisiensi dan mengurangi konsumsi bahan bakar dengan menciptakan permukaan yang halus", text_en: "To improve efficiency and reduce fuel consumption by creating a smooth surface" }, D: { text: "Untuk mendeteksi keretakan", text_en: "To detect cracks" } }, answer: "C", topic: "Shafting & Propeller" },
  { id: 95, question: "Apa yang dimaksud dengan 'Blade Area Ratio' (BAR)?", question_en: "What does 'Blade Area Ratio' (BAR) refer to?", options: { A: { text: "Rasio antara panjang dan lebar bilah", text_en: "The ratio of blade length to width" }, B: { text: "Rasio antara luas total bilah dengan luas piringan baling-baling", text_en: "The ratio of the total blade area to the propeller disc area" }, C: { text: "Rasio antara berat baling-baling dan daya mesin", text_en: "The ratio of propeller weight to engine power" }, D: { text: "Rasio kecepatan kapal terhadap kecepatan putaran baling-baling", text_en: "The ratio of ship speed to propeller RPM" } }, answer: "B", topic: "Shafting & Propeller" },

  // Other Auxiliaries (25 questions)
  {
    id: 61,
  ...
  { id: 96, question: "Fungsi utama dari 'air dryer' dalam sistem udara bertekanan adalah...", question_en: "The primary function of an 'air dryer' in a compressed air system is...", options: { A: { text: "Menghilangkan uap air dari udara", text_en: "To remove water vapor from the air" }, B: { text: "Menghilangkan oli dari udara", text_en: "To remove oil from the air" }, C: { text: "Mendinginkan udara", text_en: "To cool the air" }, D: { text: "Menaikkan tekanan udara", text_en: "To increase the air pressure" } }, answer: "A", topic: "Other Auxiliaries" },
  { id: 97, question: "Apa tujuan dari 'homogenizer' dalam sistem pengolahan bahan bakar?", question_en: "What is the purpose of a 'homogenizer' in a fuel treatment system?", options: { A: { text: "Memisahkan air dari bahan bakar", text_en: "To separate water from fuel" }, B: { text: "Memecah dan menyebarkan gugusan aspal dalam bahan bakar berat", text_en: "To break down and disperse asphaltene clusters in heavy fuel oil" }, C: { text: "Mendinginkan bahan bakar", text_en: "To cool the fuel" }, D: { text: "Mengukur viskositas bahan bakar", text_en: "To measure fuel viscosity" } }, answer: "B", topic: "Other Auxiliaries" },
  { id: 98, question: "Apa perbedaan fungsi utama antara 'bilge pump' dan 'ballast pump'?", question_en: "What is the main functional difference between a 'bilge pump' and a 'ballast pump'?", options: { A: { text: "Tidak ada perbedaan, keduanya dapat saling menggantikan", text_en: "There is no difference, they are interchangeable" }, B: { text: "Bilge pump untuk air bersih, ballast pump untuk air kotor", text_en: "Bilge pump is for clean water, ballast pump is for dirty water" }, C: { text: "Bilge pump membuang air yang tidak diinginkan dari ruang mesin, ballast pump memindahkan air untuk stabilitas", text_en: "Bilge pump removes unwanted water from machinery spaces, ballast pump transfers water for stability" }, D: { text: "Bilge pump lebih besar dari ballast pump", text_en: "Bilge pumps are larger than ballast pumps" } }, answer: "C", topic: "Other Auxiliaries" },
  { id: 99, question: "Di mana lokasi khas 'generator darurat' di kapal?", question_en: "Where is the 'emergency generator' typically located on a ship?", options: { A: { text: "Di dalam ruang mesin utama", text_en: "Inside the main engine room" }, B: { text: "Di dek paling bawah", text_en: "On the lowest deck" }, C: { text: "Di luar ruang mesin utama, di dek atas", text_en: "Outside the main engine room, on an upper deck" }, D: { text: "Di dekat anjungan", text_en: "Next to the bridge" } }, answer: "C", topic: "Other Auxiliaries" },
  { id: 100, question: "'Incinerator' di kapal terutama digunakan untuk mematuhi MARPOL Annex mana?", question_en: "An 'incinerator' on a ship is primarily used to comply with which MARPOL annexes?", options: { A: { text: "Annex IV (Sewage)", text_en: "Annex IV (Sewage)" }, B: { text: "Annex VI (Air Pollution)", text_en: "Annex VI (Air Pollution)" }, C: { text: "Annex V (Garbage) dan Annex I (Oil Sludge)", text_en: "Annex V (Garbage) and Annex I (Oil Sludge)" }, D: { text: "Annex II (Noxious Liquid Substances)", text_en: "Annex II (Noxious Liquid Substances)" } }, answer: "C", topic: "Other Auxiliaries" },
];